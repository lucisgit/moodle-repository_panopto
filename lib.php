...
class repository_panopto extends repository {
     ...
     */
    public function build_folders_tree($listfolders = array(), $parent = null, &$listsessions) {
        $tree = array();
        foreach($listfolders as $folderid => $folder) {
            if ($folder['parentfolderid'] === $parent) {
                ...
                $folder['children'] = $this->build_folders_tree($listfolders, $folderid, $listsessions);
